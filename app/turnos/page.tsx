...
const PawLogo = () => (
  <svg width="40" height="40" viewBox="0 0 48 48" fill="none">
    <circle cx="14" cy="14" r="5" fill="#4A86B8" />
    <circle cx="24" cy="10" r="5" fill="#3B739F" />
    <circle cx="34" cy="14" r="5" fill="#4A86B8" />
    <circle cx="20" cy="24" r="5" fill="#4A86B8" />
    <path
      ...
      <div className="flex min-h-screen">
        <main className="flex-1 px-10 py-8">
          <div className="flex items-start justify-between pr-20">
            ...
            <a
              href="/turnos/nuevo"
              className="rounded-xl border border-[#4a86b8] px-5 py-3 text-sm font-semibold text-[#4a86b8] shadow-sm transition hover:bg-[#edf2f8] mr-6 whitespace-nowrap"
            >
